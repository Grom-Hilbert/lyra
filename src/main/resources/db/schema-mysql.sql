...
CREATE INDEX idx_space_permissions_user_id ON space_permissions(user_id);
CREATE INDEX idx_space_permissions_space_id ON space_permissions(space_id);
CREATE INDEX idx_space_permissions_permission_id ON space_permissions(permission_id);
CREATE INDEX idx_space_permissions_resource ON space_permissions(resource_type, resource_id);
